...
app.include_router(create_router, tags=["Question Bank"])
app.include_router(delete_router, tags=["Question Bank"])
app.include_router(list_router, tags=["Question Bank"])
app.include_router(retrieve_router, tags=["Question Bank"])
app.include_router(update_router, tags=["Question Bank"])

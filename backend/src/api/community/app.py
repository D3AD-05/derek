...
app.include_router(create_router, tags=["Community"], prefix="")
app.include_router(delete_router, tags=["Community"], prefix="")
app.include_router(list_router, tags=["Community"], prefix="")
app.include_router(retrieve_router, tags=["Community"], prefix="")
app.include_router(update_router, tags=["Community"], prefix="")
